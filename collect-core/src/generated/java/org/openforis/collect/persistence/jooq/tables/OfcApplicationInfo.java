...
public class OfcApplicationInfo extends org.jooq.impl.TableImpl<org.openforis.collect.persistence.jooq.tables.records.OfcApplicationInfoRecord> {
	...
	private static final long serialVersionUID = 479045692;
	...
	private OfcApplicationInfo() {
		super("ofc_application_info", org.openforis.collect.persistence.jooq.Desre.DESRE);
	}
	...
	private OfcApplicationInfo(java.lang.String alias) {
		super(alias, org.openforis.collect.persistence.jooq.Desre.DESRE, org.openforis.collect.persistence.jooq.tables.OfcApplicationInfo.OFC_APPLICATION_INFO);
	}
