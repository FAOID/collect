...
public class OfcSurvey extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.OfcSurveyRecord> {
	...
	private static final long serialVersionUID = 412320532;
	 ...
	 */
	private OfcSurvey() {
		super("ofc_survey", org.openforis.collect.persistence.jooq.Desre.DESRE);
	}
	...
	private OfcSurvey(java.lang.String alias) {
		super(alias, org.openforis.collect.persistence.jooq.Desre.DESRE, org.openforis.collect.persistence.jooq.tables.OfcSurvey.OFC_SURVEY);
	}
