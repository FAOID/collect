...
public class OfcTaxonVernacularName extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.OfcTaxonVernacularNameRecord> {
	...
	private static final long serialVersionUID = -1175608441;
	 ...
	 * <p>
	 * <code><pre>
	 * FOREIGN KEY [desre.ofc_taxon_vernacular_name.taxon_id]
	...
	private OfcTaxonVernacularName() {
		super("ofc_taxon_vernacular_name", org.openforis.collect.persistence.jooq.Desre.DESRE);
	}
	...
	private OfcTaxonVernacularName(java.lang.String alias) {
		super(alias, org.openforis.collect.persistence.jooq.Desre.DESRE, org.openforis.collect.persistence.jooq.tables.OfcTaxonVernacularName.OFC_TAXON_VERNACULAR_NAME);
	}
