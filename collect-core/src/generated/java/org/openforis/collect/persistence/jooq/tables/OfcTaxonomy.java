...
public class OfcTaxonomy extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.OfcTaxonomyRecord> {
	...
	private static final long serialVersionUID = 1485937206;
	 ...
	 */
	private OfcTaxonomy() {
		super("ofc_taxonomy", org.openforis.collect.persistence.jooq.Desre.DESRE);
	}
	...
	private OfcTaxonomy(java.lang.String alias) {
		super(alias, org.openforis.collect.persistence.jooq.Desre.DESRE, org.openforis.collect.persistence.jooq.tables.OfcTaxonomy.OFC_TAXONOMY);
	}
