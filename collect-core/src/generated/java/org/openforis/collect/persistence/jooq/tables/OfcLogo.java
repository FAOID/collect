...
public class OfcLogo extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.OfcLogoRecord> {
	...
	private static final long serialVersionUID = 1195288476;
	 ...
	 */
	private OfcLogo() {
		super("ofc_logo", org.openforis.collect.persistence.jooq.Desre.DESRE);
	}
	...
	private OfcLogo(java.lang.String alias) {
		super(alias, org.openforis.collect.persistence.jooq.Desre.DESRE, org.openforis.collect.persistence.jooq.tables.OfcLogo.OFC_LOGO);
	}
