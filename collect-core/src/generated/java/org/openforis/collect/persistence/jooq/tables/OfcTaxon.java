...
public class OfcTaxon extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.OfcTaxonRecord> {
	...
	private static final long serialVersionUID = 156731373;
	 ...
	 * <p>
	 * <code><pre>
	 * FOREIGN KEY [desre.ofc_taxon.taxonomy_id]
	 * REFERENCES ofc_taxonomy [desre.ofc_taxonomy.id]
	 * </pre></code>
	 */
	 ...
	 * <p>
	 * <code><pre>
	 * FOREIGN KEY [desre.ofc_taxon.parent_id]
	 * REFERENCES ofc_taxon [desre.ofc_taxon.id]
	 * </pre></code>
	 */
	 ...
	 */
	private OfcTaxon() {
		super("ofc_taxon", org.openforis.collect.persistence.jooq.Desre.DESRE);
	}
	...
	private OfcTaxon(java.lang.String alias) {
		super(alias, org.openforis.collect.persistence.jooq.Desre.DESRE, org.openforis.collect.persistence.jooq.tables.OfcTaxon.OFC_TAXON);
	}
