...
public class OfcConfig extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.OfcConfigRecord> {
	...
	private static final long serialVersionUID = -1705722230;
	 ...
	 */
	private OfcConfig() {
		super("ofc_config", org.openforis.collect.persistence.jooq.Desre.DESRE);
	}
	...
	private OfcConfig(java.lang.String alias) {
		super(alias, org.openforis.collect.persistence.jooq.Desre.DESRE, org.openforis.collect.persistence.jooq.tables.OfcConfig.OFC_CONFIG);
	}
