...
public class OfcRecordRecord extends org.jooq.impl.UpdatableRecordImpl<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord> {
	...
	private static final long serialVersionUID = 500397563;
	 ...
	 * <p>
	 * <code><pre>
	 * FOREIGN KEY [collect.ofc_record.root_entity_definition_id, collect.ofc_record.survey_id]
	 * REFERENCES ofc_schema_definition [collect.ofc_schema_definition.survey_id, collect.ofc_schema_definition.id]
	 * </pre></code>
	 */
	...
	public org.openforis.collect.persistence.jooq.tables.records.OfcSchemaDefinitionRecord fetchOfcSchemaDefinition() {
		return create()
			...
			.where(org.openforis.collect.persistence.jooq.tables.OfcSchemaDefinition.OFC_SCHEMA_DEFINITION.SURVEY_ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.ROOT_ENTITY_DEFINITION_ID)))
			.and(org.openforis.collect.persistence.jooq.tables.OfcSchemaDefinition.OFC_SCHEMA_DEFINITION.ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.SURVEY_ID)))
			.fetchOne();
	}
