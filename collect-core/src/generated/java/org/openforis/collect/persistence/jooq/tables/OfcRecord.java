...
public class OfcRecord extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord> {
	...
	private static final long serialVersionUID = 1259601974;
	 ...
	 */
	private OfcRecord() {
		super("ofc_record", org.openforis.collect.persistence.jooq.Desre.DESRE);
	}
	...
	private OfcRecord(java.lang.String alias) {
		super(alias, org.openforis.collect.persistence.jooq.Desre.DESRE, org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD);
	}
